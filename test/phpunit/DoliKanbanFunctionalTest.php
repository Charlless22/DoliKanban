...
/**
 * \file    test/phpunit/DoliKanbanFunctionalTest.php
 * \ingroup dolikanban
...
/**
 * Class DoliKanbanFunctionalTest
 *
 ...
 *
 * @package Testdolikanban
 */
class DoliKanbanFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modDoliKanban')->click();
		} else {
			// Disable the module
			$this->byHref('modDoliKanban')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/dolikanban/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('dolikanban/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/dolikanban/admin/about.php');
		$this->authenticate();
		return $this->assertContains('dolikanban/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('dolikanbanwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modDoliKanban_DoliKanbanTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modDoliKanban_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
